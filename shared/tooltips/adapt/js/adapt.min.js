require(['bowser', 'underscore', 'backbone', 'semver', 'react', 'react-dom', 'html-react-parser', 'libraries/mediaelement-and-player', 'libraries/SCORM_API_wrapper', 'libraries/lzma-min', 'libraries/lzma_worker-min.js', 'libraries/js-cookie.js'], (function (Bowser, _$1, Backbone$1, semver, React, ReactDOM, HTMLReactParser, mediaelementAndPlayer, pipwerks, lzmaMin, lzma_workerMin_js, Cookies) { 'use strict';
  ...
  class DrawerView extends Backbone__default["default"].View {
    ...
    initialize() {
      ...
      this._globalDrawerPosition = Adapt$1.config.get('_drawer')?._position ?? 'auto';
    ...
    openCustomView(view) {
      let hasBackButton = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
  ...
  var TooltipItemView = __AMD("core/js/views/TooltipItemView", class TooltipItemView extends Backbone.View {
    className() {
      return ['tooltip__target', this.model.get('isTargetFixedPosition') && 'tooltip-fixed', this.model.get('tooltipClasses') || 'is-vertical-axis is-top is-middle is-arrow-middle', this.model.get('isShown') && 'is-shown', this.model.get('_classes')].filter(Boolean).join(' ');
    }
    attributes() {
      return {
        id: `tooltip-${this.model.get('_id')}`,
        style: Object.entries(this.model.get('tooltipStyles') ?? {}).map(_ref => {
          let [name, value] = _ref;
          return `${name}: ${value};`;
        }).join(' ')
      };
    ...
    initialize(_ref2) {
      ...
      this.listenTo(Adapt$1, 'device:resize', this.onDeviceResize);
  ...
  function parseRelativePosition(_ref3) {
    let {
      position
    } = _ref3;
    ...
    const verticalIndex = Math.min(...['top', 'bottom'].map(v => positions.indexOf(v)).filter(v => v !== -1));
    const horizontalIndex = Math.min(...['left', 'right'].map(v => positions.indexOf(v)).filter(v => v !== -1));
  ...
  function calculateScrollOffset(_ref4) {
    let {
      isTargetFixedPosition
    } = _ref4;
  ...
  function position() {
    ...
    let multipassCache = arguments.length > 1 ? arguments[1] : undefined;
    let pass = arguments.length > 2 ? arguments[2] : undefined;
    const {
      offset,
      distance,
      viewPortPadding
    ...
    const tooltipClasses = [isOutside && 'is-outside', isInside && 'is-inside', isArrowSnap && 'is-arrow-snap', isVerticalAxis && 'is-vertical-axis', isHorizontalAxis && 'is-horizontal-axis', isMiddleFirst && 'is-middle-axis', isLeft && 'is-left', isMiddle && 'is-middle', isRight && 'is-right', isFillWidth && 'is-fill-width', isSnapLeft && 'is-snap-left', isSnapRight && 'is-snap-right', isTop && 'is-top', isCenter && 'is-center', isBottom && 'is-bottom', isFillHeight && 'is-fill-height', isSnapTop && 'is-snap-top', isSnapBottom && 'is-snap-bottom', isArrowStart && 'is-arrow-start', isArrowMiddle && 'is-arrow-middle', isArrowEnd && 'is-arrow-end'].filter(Boolean).join(' ');
    const {
      scrollOffsetLeft,
      scrollOffsetTop
  ...
  var TooltipView = __AMD("core/js/views/TooltipView", class TooltipView extends Backbone.View {
    ...
    initialize() {
      ...
      this._tooltipData = {};
      this._tooltips = [];
      this.listenTo(Adapt$1, 'adapt:preInitialize', this.onAdaptPreInitialize);
      this.render();
    }
    ...
    get config() {
      return Adapt$1.course.get('_tooltips');
    }
    onKeyDown(event) {
    ...
    hide() {
      let tooltipItem = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  ...
  class Drawer extends Backbone__default["default"].Controller {
    ...
    close() {
      let $toElement = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    ...
    async navigateToElement(selector) {
      ...
      await new Promise(resolve => {
        _.delay(() => {
          ...
          Adapt$1.trigger(`${location$1}:scrolledTo`, selector);
          resolve();
  ...
  class Tracking extends Backbone.Controller {
    ...
    checkCompletion() {
      ...
      if (!this._config._submitOnEveryAssessmentAttempt && completionData.status === COMPLETION_STATE$1.FAILED && canRetry) return;
    ...
    getCompletionData() {
      ...
      if (this._config._requireAssessmentCompleted) {
        ...
        completionData.status = isPassed ? COMPLETION_STATE$1.PASSED : COMPLETION_STATE$1.FAILED;
  ...
  Adapt$1.on({
    ...
    'drawer:triggerCustomView'() {
      logging$1.deprecated('Use drawer.triggerCustomView(), Adapt.trigger(\'drawer:triggerCustomView\') will be removed in the future');
      drawer.triggerCustomView();
    }
  });
  ...
  class NavigationView$1 extends Backbone.View {
    ...
    initialize() {
      ...
      this.listenTo(Adapt$1, 'router:menu router:page', this.hideNavigationButton);
      this.preRender();
    }
    preRender() {
  ...
  class NavigationController extends Backbone.Controller {
    ...
    onDeviceResize() {
      ...
      const isBottomOnTouchDevices = device$1.touch && adaptConfig?._isBottomOnTouchDevices;
  ...
  class QuestionModel extends ComponentModel$1 {
    ...
    getFeedback() {
      let _feedback = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.get('_feedback');
      if (!_feedback) return {};
      const isFinal = this.get('_attemptsLeft') === 0;
      const correctness = this.get('_isCorrect') ? 'correct' : this.isPartlyCorrect() ? 'partlyCorrect' : 'incorrect';
      let {
        altTitle,
        title,
        _classes
      } = _feedback;
      altTitle = altTitle || Adapt$1.course.get('_globals')._accessibility.altFeedbackTitle || '';
        ...
        case 'partlyCorrect':
          {
            if (typeof _feedback._partlyCorrect === 'object') {
              return {
                ...
                title,
                _classes,
                body: !isFinal ? _feedback._partlyCorrect?.notFinal || _feedback._incorrect?.notFinal || '' : _feedback._partlyCorrect?.final || _feedback._incorrect?.final || ''
              };
            }
        ...
        case 'incorrect':
          {
            if (typeof _feedback._incorrect === 'object') {
              return {
                ...
                title,
                _classes,
                body: !isFinal ? _feedback._incorrect.notFinal : _feedback._incorrect.final
              };
            }
  ...
  class HotgraphicPopupView extends Backbone.View {
    ...
    manageBackNextStates() {
      let index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.model.getActiveItem().get('_index');
  ...
  class HotGraphicView extends ComponentView$1 {
    ...
    replaceWithNarrative() {
      ...
      const $container = data$1.findViewByModelId(model.get('_parentId')).$el.find('.component__container');
  ...
  var HotgraphicModel = __AMD("components/adapt-contrib-hotgraphic/js/hotgraphicModel", class HotgraphicModel extends ItemsComponentModel {
    ...
    setUpItems() {
      ...
      tooltip._id = `hotgraphic-pin-${id}-background`;
      tooltips$1.register({
        ...this.toJSON(),
  ...
  class MediaView extends ComponentView$1 {
    ...
    onToggleInlineTranscript(event) {
      ...
      if (this.model.get('_transcript')._setCompletionOnView !== false) {
        Adapt$1.trigger('media:transcriptComplete', this);
        this.setCompletionStatus();
      }
    }
  ...
  class NarrativeView extends ComponentView$1 {
    ...
    calculateMode() {
      const mode = device$1.screenSize === 'large' ? MODE.LARGE : MODE.SMALL;
    ...
    isTextBelowImage() {
      const isTextBelowImage = device$1.screenSize === 'large' ? this.model.get('_isTextBelowImage') : this.model.get('_isMobileTextBelowImage');
  ...
  var SliderModel = __AMD("components/adapt-contrib-slider/js/SliderModel", class SliderModel extends QuestionModel$1 {
    ...
    restoreUserAnswers() {
      ...
      const items = this.get('_items');
      const userAnswer = this.get('_userAnswer');
      const selectedItem = items.find(_ref => {
        let {
          value
        } = _ref;
    ...
    isCorrect() {
      const numberOfCorrectAnswers = this.get('_items').filter(_ref2 => {
        let {
          selected,
          correct
        } = _ref2;
  ...
  class TextInputModel extends QuestionModel$1 {
    ...
    canSubmit() {
      return this.get('_items').every(_ref => {
        let {
          userAnswer
        } = _ref;
        return userAnswer;
    ...
    isCorrect() {
      ...
      return this.get('_items').every(_ref3 => {
        let {
          _isCorrect
        } = _ref3;
        return _isCorrect;
    ...
    getResponse() {
      return this.get('_items').map(_ref4 => {
        let {
          userAnswer
        } = _ref4;
        return userAnswer;
  ...
  class Bookmarking extends Backbone.Controller {
    ...
    checkCourseIsEnabled() {
      const courseBookmarkModel = Adapt$1.course.get('_bookmarking');
    ...
    showPrompt() {
      const courseBookmarkModel = Adapt$1.course.get('_bookmarking');
      const buttons = courseBookmarkModel._buttons || {
        yes: 'Yes',
        no: 'No'
      };
      this.listenToOnce(Adapt$1, {
    ...
    navigateToPrevious() {
      _.defer(async () => {
        ...
        try {
          await router$1.navigateToElement(this.restoredLocationID, {
            trigger: true,
            replace: isSinglePage,
            duration: 400
          });
        } catch (err) {
          logging$1.warn(`Bookmarking cannot navigate to id: ${this.restoredLocationID}\n`, err);
        }
      });
    ...
    getBookmarkLevel(pageModel) {
      const defaultLevel = Adapt$1.course.get('_bookmarking')._level || 'component';
  ...
  var GlossaryItemView = __AMD("extensions/adapt-contrib-glossary/js/adapt-contrib-glossaryItemView", class GlossaryItemView extends Backbone.View {
    className() {
    ...
    onGlossaryItemClicked(event) {
      ...
      Adapt$1.trigger('glossary:termSelected', this.model);
    }
  ...
  var GlossaryView = __AMD("extensions/adapt-contrib-glossary/js/adapt-contrib-glossaryView", class GlossaryView extends Backbone.View {
    className() {
      return 'glossary';
    }
    events() {
    ...
    renderIndexHeader() {
      ...
      Object.entries(this.collection._byChar0).forEach(_ref => {
        let [key, group] = _ref;
    ...
    renderGlossaryItemsWithHeaders() {
      ...
      Object.entries(this.collection._byChar0).forEach(_ref2 => {
        let [key, group] = _ref2;
    ...
    createItemViews(models, $container) {
      models.forEach(item => {
        const itemView = new GlossaryItemView({
          model: item
        });
  ...
  function setupGlossary(glossaryModel, glossaryItems) {
    ...
    Adapt$1.on('glossary:showGlossary', () => {
  ...
  function initGlossary() {
    const courseGlossary = Adapt$1.course.get('_glossary');
  ...
  var LanguagePickerNavView = __AMD("extensions/adapt-contrib-languagePicker/js/languagePickerNavView", class LanguagePickerNavView extends Backbone.View {
    tagName() {
      return 'button';
    }
    className() {
  ...
  var LanguagePickerModel = __AMD("extensions/adapt-contrib-languagePicker/js/languagePickerModel", class LanguagePickerModel extends Backbone.Model {
    ...
    getLanguageDetails(language) {
      return this.get('_languages').find(_ref => {
        let {
          _language
        } = _ref;
    ...
    onDataLoaded() {
      const shouldReset = !this.get('_restoreStateOnLanguageChange');
      const hasOfflineStorageClear = Boolean(Adapt$1.offlineStorage.clear);
  ...
  class LanguagePicker extends Backbone.Controller {
    ...
    setupNavigationView() {
      const courseGlobals = Adapt$1.course.get('_globals')._extensions;
  ...
  class Completion extends Backbone.Controller {
    ...
    calculateCompletion(contentObjectModel) {
      let setGlobal = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      const completion = {};
  ...
  class PageLevelProgressIndicatorView extends Backbone.View {
    ...
    setUpEventListeners() {
      ...
      this.listenTo(Adapt$1.course, 'bubble:change:_isComplete', this.refresh);
    }
  ...
  var PageLevelProgressNavigationView = __AMD("extensions/adapt-contrib-pageLevelProgress/js/PageLevelProgressNavigationView", class PageLevelProgressNavigationView extends Backbone.View {
    ...
    setUpEventListeners() {
      ...
      this.listenTo(data$1, 'change:_isLocked change:_isComplete', this.refreshProgressBar);
    }
    render() {
    ...
    refreshProgressBar() {
      this.collection = getPageLevelProgressItems(this.model);
  ...
  class ScormWrapper {
    ...
    setScore(score) {
      let minScore = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      let maxScore = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 100;
      if (this.isSCORM2004()) {
    ...
    handleError(error) {
      if (!Adapt$1.get('_isStarted')) {
        Adapt$1.once('contentObjectView:ready', this.handleError.bind(this, error));
        return;
      }
  ...
  class FixedIntegerType extends AbstractValueType {
    ...
    valueToBinary(integer) {
      let logStats = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
  ...
  class Converter {
    ...
    valueToBinary(value) {
      let typeName = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      let logStats = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      this.clearLog();
  ...
  var StatefulSession = __AMD("extensions/adapt-contrib-spoor/js/adapt-stateful-session", class StatefulSession extends Backbone.Controller {
    ...
    beginSession() {
      this.listenTo(Adapt$1, 'app:dataReady', this.restoreSession);
    ...
    onLanguageChanged() {
      ...
      offlineStorage$1.set('status', 'incomplete');
    }
    onVisibilityChange() {
    ...
    onQuestionRecordInteraction(questionView) {
      ...
      offlineStorage$1.set('interaction', id, response, result, latency, responseType);
    }
  ...
  var OfflineStorage = __AMD("extensions/adapt-contrib-spoor/js/adapt-offlineStorage-scorm", class OfflineStorageScorm extends Backbone.Controller {
    ...
    serialize() {
      return SCORMSuspendData.serialize(...arguments);
    }
    deserialize() {
      return SCORMSuspendData.deserialize(...arguments);
    }
    get(name) {
      if (name === undefined) {
  ...
  class Tutor extends Backbone.Controller {
    ...
    onComponentViewPostRender(view) {
      ...
      if (!config) return;
      const type = TUTOR_TYPE$1(config._type?.toUpperCase());
      if (type !== TUTOR_TYPE$1.INLINE) return;
      this.listenToOnce(Adapt$1, 'buttonsView:postRender', this.onButtonsViewPostRender);
  ...
  var ThemeView = __AMD("theme/adapt-contrib-vanilla/js/themeView", class ThemeView extends Backbone.View {
    ...
    setBackgroundImage() {
      ...
      if (backgroundImage) {
        ...
        this.$background.css('background-image', 'url(' + backgroundImage + ')');
        return;
      }
    ...
    setResponsiveClasses() {
      ...
      this.$el.removeClass(Object.values(responsiveClasses)).addClass(responsiveClasses[`_${Adapt$1.device.screenSize}`]);
    }
    setCustomStyles() {}
    onRemove() {}
  });
  ...
  var ThemePageView = __AMD("theme/adapt-contrib-vanilla/js/themePageView", class ThemePageView extends ThemeView {
    ...
    setHeaderBackgroundImage(config, $header) {
      ...
      if (backgroundImage) {
        ...
        this.$headerBackground.css('background-image', 'url(' + backgroundImage + ')');
        return;
      }
  ...
  register("tooltip", function Tooltip(props) {
    ...
    return React__default["default"].createElement(React__default["default"].Fragment, null, React__default["default"].createElement("div", {
      className: classes(['tooltip__arrow', 'has-arrow']),
      "aria-hidden": "true"
    }), React__default["default"].createElement("div", {
      className: classes(['tooltip', 'js-tooltip']),
  ...
  register("accordion", function Accordion(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("div", {
        className: classes(['accordion-item', 'js-accordion-item', _graphic?.src && 'has-image', _graphic?.src && _imageAlignment && `align-image-${_imageAlignment}`, _classes]),
        key: _index,
        "data-index": _index
      }, React__default["default"].createElement("div", {
        role: "heading",
  ...
  register("gmcq", function Gmcq(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("div", {
        className: classes([`gmcq-item item-${index}`, _shouldShowMarking && _shouldBeSelected ? 'is-correct' : null, _shouldShowMarking && !_shouldBeSelected ? 'is-incorrect' : null]),
        ...
        disabled: !_isEnabled,
        checked: _isActive,
        "aria-label": !_shouldShowMarking ? `${a11y$1.normalize(text)} ${_graphic?.alt || ''}` : `${_shouldBeSelected ? ariaLabels.correct : ariaLabels.incorrect}, ${_isActive ? ariaLabels.selectedAnswer : ariaLabels.unselectedAnswer}. ${a11y$1.normalize(text)} ${_graphic?.alt || ''}`,
        ...
        className: classes(['gmcq-item__label', 'js-item-label', 'u-no-select', !_isEnabled && 'is-disabled', (_isCorrectAnswerShown ? _shouldBeSelected : _isActive) && 'is-selected']),
        "aria-hidden": true,
  ...
  register("hotgraphicLayoutPins", function HotgraphicLayoutPins(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("div", {
        ...
        className: classes(['btn-icon hotgraphic__pin', `item-${_index}`, _graphic._classes, _isVisited && 'is-visited', _pin.src && 'has-pin-image']),
        "data-index": _index,
        ...
        className: "hotgraphic__pin-image",
        src: _pin.src,
        "aria-hidden": "true"
      })), !_pin.src && _useNumberedPins && React__default["default"].createElement("span", {
        className: "hotgraphic__pin-number",
        "aria-hidden": "true"
      }, index + 1), !_pin.src && !_useNumberedPins && React__default["default"].createElement("span", {
        className: "icon",
        "aria-hidden": "true"
      })));
    })));
  ...
  register("hotgraphicPopup", function HotgraphicPopup(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement("div", {
        className: classes(['hotgraphic-popup__item', _classes, _isRound && 'is-round', _isVisited && 'is-visited', _isActive && 'is-active', _imageAlignment && `align-image-${_imageAlignment}`]),
        key: index,
        "data-index": index,
        ...
        className: classes(['hotgraphic-popup__item-title', _isActive && 'notify-heading']),
        "aria-level": a11y$1.ariaLevel({
          level: 'notify'
        })
      }, React__default["default"].createElement("div", {
        ...
        className: classes(['hotgraphic-popup__item-image-container', _graphic.attribution && 'has-attribution'])
      }, React__default["default"].createElement("img", {
        ...
        className: "component__attribution hotgraphic-popup__attribution"
      }, React__default["default"].createElement("div", {
        className: "component__attribution-inner hotgraphic-popup__attribution-inner",
        dangerouslySetInnerHTML: {
          __html: _graphic.attribution
        }
      }))));
  ...
  register("narrative", function Narrative(props) {
    ...
    const narrativeWidgetRef = React.useRef(null);
    React.useEffect(() => {
    ...
    return React__default["default"].createElement("div", {
      className: classes(['component__inner narrative__inner', _mode === MODE.LARGE ? 'mode-large' : 'mode-small', _isTextBelowImageResolved && 'items-are-full-width'])
    }, React__default["default"].createElement(templates.header, props), React__default["default"].createElement("div", {
      className: classes(['component__widget narrative__widget', _hasNavigationInTextArea && 'narrative__text-controls']),
      ...
      return React__default["default"].createElement("button", {
        ...
        dangerouslySetInnerHTML: {
          __html: compile(strapline, props)
        }
      })), React__default["default"].createElement("span", {
      ...
      return React__default["default"].createElement("div", {
        ...
        src: _graphic.src,
        "aria-label": a11y$1.normalize(_graphic.alt) || null,
        "aria-hidden": !_graphic.alt || null,
        draggable: "false"
      }), _graphic.attribution && React__default["default"].createElement("div", {
        className: "component__attribution narrative__attribution"
      }, React__default["default"].createElement("div", {
  ...
  register("slider", function Slider(props) {
    ...
    const sliderScaleRef = React.useRef(null);
    const sliderNumberSelectionRef = React.useRef(null);
    const [sliderScaleWidth, setSliderScaleWidth] = React.useState(0);
    ...
    React.useEffect(() => {
      ...
      Adapt$1.on('device:resize', onResize);
      onResize();
      return () => Adapt$1.off('device:resize', onResize);
    }, [Adapt$1, _isReady]);
    React.useEffect(() => {
      ...
      $(sliderNumberSelectionRef.current).velocity('stop').velocity({
        left: pixels
      }, {
        duration: 200,
        easing: 'linear',
    ...
    return React__default["default"].createElement("div", {
      ...
      className: classes(['component__widget slider__widget', !_isEnabled && 'is-disabled', _isInteractionComplete && 'is-complete is-submitted show-user-answer', _shouldShowMarking && _isCorrect && 'is-correct', _shouldShowMarking && !_isCorrect && 'is-incorrect']),
      "aria-labelledby": ariaQuestion ? null : (displayTitle || body || instruction) && `${_id}-header`,
      "aria-label": ariaQuestion || null
      ...
      className: "aria-label"
    }, _globals._components._slider.labelStart, " ", _scaleStart), labelStart)), labelEnd && React__default["default"].createElement("div", {
      className: "slider__label-end"
    }, React__default["default"].createElement("div", {
      className: "slider__label-end-inner"
    }, React__default["default"].createElement("span", {
      className: "aria-label"
    }, _globals._components._slider.labelEnd, " ", _scaleEnd), labelEnd))), React__default["default"].createElement("div", {
      className: "slider__number-container"
    }, _showScale && _showScaleNumbers && _items.map((_ref, index) => {
      let {
        value
      } = _ref;
      ...
      return React__default["default"].createElement("div", {
        ...
        "aria-hidden": "true",
        style: {
          left: Math.round(normalisedPosition * sliderScaleWidth)
        },
      ...
      return React__default["default"].createElement("div", {
        ...
        key: correctAnswer,
        style: {
          left: `${mapIndexToPixels(getIndexFromValue(correctAnswer))}px`
        }
    ...
    }, _showNumber && _selectedItem.value)), React__default["default"].createElement("div", {
      ...
      style: {
        left: `${mapIndexToPixels(index + 1)}px`
      },
      key: item.value
    }))), React__default["default"].createElement("div", {
  ...
  register("pageLevelProgressItem", function PageLevelProgressItem(props) {
    ...
    return React__default["default"].createElement("div", {
      className: classes(['pagelevelprogress__item drawer__item', `${_type}__indicator`]),
      role: "listitem"
    }, React__default["default"].createElement("button", {
      className: classes(['pagelevelprogress__item-btn drawer__item-btn', 'js-indicator js-pagelevelprogress-item-click', (_isLocked || !_isVisible) && 'is-disabled']),
      ref: indicatorSeat,
    ...
    }, _globals._extensions._pageLevelProgress.optionalContent))), React__default["default"].createElement("div", {
  ...
  register("resources", function Resources(props) {
    ...
    function resourcesHasMultipleTypes(resources) {
      ...
      const allSameType = resources.every(_.matcher({
    ...
    return React__default["default"].createElement("div", {
    ...
    }, React__default["default"].createElement(templates.header, props.model), resourcesHasMultipleTypes(resources) && React__default["default"].createElement("div", {
      className: classes(['resources__filter', `has-${resourcesGetColumnCount(resources)}-columns`])
    }, React__default["default"].createElement("div", {
      ...
      return React__default["default"].createElement(templates.resourcesItem, _extends({}, props, {
        key: index,
        title: title,
  ...
  register("resourcesFilterButton", function ResourcesFilterButton(props) {
    ...
    function resourcesHasType(resources, type) {
      return resources.some(_.matcher({
        _type: type
      }));
    }
