require(['bowser', 'underscore', 'backbone', 'semver', 'react', 'react-dom', 'html-react-parser', 'libraries/mediaelement-and-player', 'libraries/SCORM_API_wrapper', 'libraries/lzma-min', 'libraries/lzma_worker-min.js', 'libraries/js-cookie.js'], (function (Bowser, _$1, Backbone$1, semver, React, ReactDOM, HTMLReactParser, mediaelementAndPlayer, pipwerks, lzmaMin, lzma_workerMin_js, Cookies) { 'use strict';
  ...
  class Device extends Backbone.Controller {
    ...
    checkScreenSize() {
      ...
      const screenSize = screenSizesList.reduce((screenSize, _ref) => {
        let [name, value] = _ref;
  ...
  var TooltipView = __AMD("core/js/views/TooltipView", class TooltipView extends Backbone.View {
    ...
    onAdaptPreInitialize() {
      ...
      $(document).on('focus', '[data-tooltip-id]', function () {
        if (a11y$1.isForcedFocus) return;
        _this.onMouseOver(...arguments);
      });
  ...
  var NavigationButtonView = __AMD("core/js/views/NavigationButtonView", class NavigationButtonView extends Backbone.View {
    ...
    updateViewProperties() {
      ...
      Object.entries(_.result(this, 'attributes')).forEach(_ref2 => {
        let [name, value] = _ref2;
        return this.$el.attr(name, value);
      });
      this.$el.removeClass(classesToRemove).addClass(classesToAdd);
    }
    injectLabel() {
  ...
  class NavigationView$1 extends Backbone.View {
    ...
    sortNavigationButtons(changed) {
      if (Array.isArray(changed)) {
        ...
        const shouldIgnore = changes.every(_ref => {
          let [key] = _ref;
          return ['attributes.data-a11y-force-focus', 'attributes.tabindex', 'attributes.aria-hidden', 'attributes.aria-expanded'].includes(key);
        });
      ...
      items.forEach(el => {
        ...
        const foundId = ($el.attr('name') ?? Object.entries(identifiers).find(_ref2 => {
          let [classes] = _ref2;
          return $el.is(classes);
        })?.[1]) || $el.attr('class');
        const attributes = {
          _id: foundId,
  ...
  __AMD("core/js/navigation", Adapt$1.navigation = new NavigationController().navigation);
        ...
        case 'incorrect':
          {
            if (typeof _feedback._incorrect === 'object') {
              return {
                ...
                title,
                _classes,
                body: !isFinal ? _feedback._incorrect.notFinal || _feedback._incorrect.final : _feedback._incorrect.final
              };
            }
  ...
  class NarrativeView extends ComponentView$1 {
    ...
    setFocus(itemIndex) {
      const $animatedElement = this.isLargeMode() ? this.$('.narrative__slider') : this.$('.narrative__strapline-header-inner');
    ...
    focusOnNarrativeElement(itemIndex) {
      ...
      const $elementToFocus = this.isLargeMode() ? this.$(`.narrative__content-item${dataIndexAttr}`) : this.$(`.narrative__strapline-btn${dataIndexAttr}`);
  ...
  var Connection = __AMD("extensions/adapt-contrib-spoor/js/scorm/Connection", class Connection {
    constructor() {
      ...
      let ScormWrapper = arguments.length > 1 ? arguments[1] : undefined;
  ...
  class ScormWrapper {
    ...
    setScore(score) {
      ...
      let isPercentageBased = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
      if (this.isSCORM2004()) {
    ...
    async handleInitializeError() {
      ...
      _.defer(() => this.handleError(new ScormError$1(CLIENT_COULD_NOT_CONNECT)));
    }
    ...
    handleDataError(error) {
      Adapt$1.trigger('tracking:dataError');
  ...
  class Tutor extends Backbone.Controller {
    ...
    getTutorType(model) {
      ...
      if (!config) return;
      return TUTOR_TYPE$1(config._type?.toUpperCase()).asString;
    }
  ...
  register("header", function Header(props) {
    ...
    const sizedInstruction = mobileInstruction && device$1.isScreenSizeMax('small') ? mobileInstruction : instruction;
  ...
  register("image", function Image(props) {
    const hasMatchingSetting = Object.prototype.hasOwnProperty.call(props, `_${device$1.screenSize}`) || Object.prototype.hasOwnProperty.call(props, device$1.screenSize);
  ...
  register("gmcq", function Gmcq(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      className: classes(['component__widget', 'gmcq__widget', !_isEnabled && 'is-disabled', _isInteractionComplete && 'is-complete is-submitted show-user-answer', _isCorrect && 'is-correct', _columns && hasColumnLayout && 'has-column-layout']),
  ...
  register("hotgraphicLayoutPins", function HotgraphicLayoutPins(props) {
    ...
    return React__default["default"].createElement("div", {
      ...
      const itemCount = compile(globals._components?._hotgraphic?.popupPagination || '', {
        itemNumber: _index + 1,
  ...
  register("slider", function Slider(props) {
    ...
    }, _showScale && _showScaleNumbers && _items.map(_ref => {
      let {
        index,
        value
      } = _ref;
    ...
    }, _showNumber && `${scaleStepPrefix}${_selectedItem.value}${scaleStepSuffix}`)), React__default["default"].createElement("div", {
